...
figure_square::figure_square(int x, int y, unsigned int my_color, bool clar, bool paint) {
...
void figure_square::figure_position_for_track(int& x, int& y) {
	x = array_x_move[1];
	y = array_y_move[1];
}
...
void figure_square::return_to_start_position(void) {
	for (int i = 0; i < quantity_of_point; i++) {
